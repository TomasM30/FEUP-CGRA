...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.prism = new MyPrism(this, 6, 10);
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.805, 0.51, 0.34, 1.0);
        this.material4.setDiffuse(0.805, 0.51, 0.34, 1.0);
        ...
        // Labels and ID's for object selection on MyInterface
        this.materialIDs = {'Red Ambient': 0, 'Red Diffuse': 1, 'Red Specular': 2, 'Wood Color': 3 ,'Custom': 4 };
    }
    display() {
