...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        gardenFolder.add(this.scene, 'gardenRows', 1, 10, 5).name('Garden Rows').onChange(this.scene.updateGarden.bind(this.scene));
        //Slider element for Garden Columns in GUI
        gardenFolder.add(this.scene, 'gardenColumns', 1, 10, 5).name('Garden Columns').onChange(this.scene.updateGarden.bind(this.scene));
